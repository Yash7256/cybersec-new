...
export default function TracerouteResultsPage({
  ...
  return (
    <div className="flex flex-col gap-6 min-w-0">
      {error && (
        <section className="rounded-xl border border-[#ff4d4d] bg-[#201330]/82 p-7 shadow-[0_18px_60px_rgba(0,0,0,0.18)]">
          <p className="m-0 text-[#ff4d4d]">Traceroute failed: {error}</p>
        </section>
      )}

      {loading && !result && (
        <section className="rounded-xl border border-white/[0.14] bg-[#201330]/82 p-7 shadow-[0_18px_60px_rgba(0,0,0,0.18)]">
